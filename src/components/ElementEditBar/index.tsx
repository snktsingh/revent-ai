...
const ElementEditBar: React.FC<ElementEditBarProps> = ({ left, top, canvas }) => {
    ...
    return (
        <EditBarContainer ref={editBarRef} left={position.l} top={position.t} className='add-level-step'>
            ...
            {aiCheckbox &&
                <CheckboxContainer>
                    <input type="checkbox" checked={enhancementWithAI} onChange={(e) => handleAICheckbox(e.target.checked)} />
                    <AiSlashIcon />
                    <AiIcon />
                </CheckboxContainer>
            }
...
const AiIcon = () => {
    return <svg className="ai" width="28" height="28" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="icon" fill="#004FBA" transform="translate(64.000000, 64.000000)">

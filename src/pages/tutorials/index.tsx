...
import { FlexContainer, HeaderContainer, LeftContainer, RightContainer, StyledTab, StyledTabs, TutorialContainer, TutorialHeading, VideoContainer, VideoTitle } from './style';

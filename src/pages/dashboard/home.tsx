...
import { togglePresetOpened, toggleTour } from '@/redux/thunk/dashboard';
...
import useStartTheme from '../themes/container';
      ...
      >
        ...
        >
          <Box
            ...
            alignItems="center"
          >
            <p style={{ color: '#004fba', fontSize: '16px' }}>New user ?</p>
            <h3
              style={{
